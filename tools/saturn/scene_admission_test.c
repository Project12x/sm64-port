                        ...
                        uint16_t *portal_refs)
{
    ...
    *scene = (sm64_saturn_scene_admission_view_t){
        ...
        .portal_refs = portal_refs, .portal_ref_count = 3U,
        .root_node = 0U,
    };
    ...
    portal_refs[0] = 0U; portal_refs[1] = 1U; portal_refs[2] = 0U;
...
int main(void)
{
    ...
    uint16_t cluster_refs[3], portal_refs[3], admitted[4], admitted_portals[4];
