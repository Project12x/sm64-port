...
- Candidate source:
  ...
  537dd7210c2846e283c21a12a32770d601218c0c. Release evidence/public status:
  6685084aa258238a312dd6228f649e4b30328792.
- Round-2 review root cause: extracted-asset cleanup validated a mutable
  ancestor chain and later resolved it again for path-based deletion. A
  deterministic post-validation junction swap deleted an outside file.
  Same-repository close-port reuse from Task 7's DirectoryNamespaceGuard and
  path_identity now pins the full namespace and deletes relative to the held
  POSIX descriptor or through the exact verified Windows handle. Missing
  capability fails closed; pruning never reaches the output root.
- TDD RED: 7 extractor tests, exactly two intended failures (ancestor-swap
  outside deletion and missing-capability deletion). GREEN: 7/7 with one
  link-capability skip, including outside/displaced/root survival. Shared
  Task 7 regressions pass release manifest 28/28 and staging 20/20.
- Fresh post-pin host verification: checkout 1/1, attestation 17/17, hermetic
  Make 19/19, bootstrap 15/15, closure 27/27 (one skip), manifest 28/28,
  staging 20/20, sealer 12/12, and native math 243/244 with exactly the
  approved pre-existing null-camera-trigger proof failure.
- Candidate A/B used independently copied non-reparse prerequisites and clean
  owned output at the same source. Exact -j1 builds exited 0 in 924.0/937.2
  seconds. Both independently verify at manifest
  9110b40da0e890b7b03dc5748e9ead4a47865ea4f9e3df21869b47de33679b99,
  identity id-a40f992c085da2f0, ELF dcf4123f...3010, closure
  4f6a2feb...da3, package 85a5a190...c266, toolchain e74c5bad...48db, and
  exact clean provenance df7894ac. Comparison is identical:true with zero
  fields; report SHA-256 8edf96639c5c8244bab7bb171c9bf488b7b0df878417c0e24025cd7f0264eabc.
- Unsealed measurement passed at total 700 with both forbidden callers absent;
  report SHA-256 148bec4b...bcf1. The one-shot 606-byte contract is
  14db6bfb...b8b; historical v2/v3 remain 87dabb51...6127e2 and
  80f66286...9cba5. Exact v4 exited 0 in 383.3 seconds and published status
  passed at report SHA-256 2e37d74b...c286.
- Capacity/package: ___end=0x060fca38; HWRAM margins 13,768 physical and 6,856
  usable; cart 3,565,696 bytes with 628,608 headroom; all three SOURCE.DAT
  copies equal f0d3781c...fde6c; ISO af194c75...e398 at LBA 534/1,742
  blocks; exactly ten BOB package classes. Capacity 208 exceeds the prior
  artifact-bound idle-boot peak 138 by 70, but 138 is a floor without
  pickup/hold/action-particle coverage and Task 9 ran no new occupancy route.
- Canonical staging contains five files/17,982,718 bytes and directly verifies
  manifest 9110b40d...b99. The previous manifest-5e04 stage is recoverable at
  .superseded-5e04e252. A repeated stage exited 1, inventory remained
