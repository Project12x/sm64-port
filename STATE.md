...
epoch stall.** **(1a) Host-contract-passed (W0): bound the overwrite fence.**
...
The known pre-W0 presentation-boundary literal drift remains unchecked;
target-equivalent normal/diagnostic compilation, memory margins, and live
observation are still pending.
