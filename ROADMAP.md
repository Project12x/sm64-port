...
- **Bound the VDP1 overwrite fence — normal live-observed; diagnostic
  target-compiled; review and owner gates pending.**
  ...
  unproven`; no diagnostic capture condition arose. The known pre-W0
