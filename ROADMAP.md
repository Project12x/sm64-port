...
complete after its real-source binding repair passed scoped rereview with
C0/I0/M0; Task 4 real BOB bundle orchestration is resumed. Next build/review
the scene-local DRAM-cart bundle and fixed dual-SH-2 LWRAM
