...
**Current status (2026-08-11):** `active` in independent-review repair round 2.
Round-1 candidates at source `04d6a2a3`, manifest `5e04e252...11c1df`, and
identity `id-264ab4203c268487` are superseded because the sealed asset extractor
still resolved a validated cleanup path again at unlink time. A swapped
ancestor could redirect deletion outside the generated output root. The source
repair must pass deterministic namespace-race coverage, then two clean
candidates must rebuild at one common round-2 source commit and every manifest,
measurement, v4 contract/result, capacity/package, and staged artifact must be
replaced. Step 11 and every Task 10/Ymir/manual gate remain unchecked. Full
details and discarded-run accounting are in
...
release-manifest 28/28 and staging 20/20. The round-1 release/audit/stage
evidence remains superseded; clean A/B rebuild, comparison, measurement, v4
reseal/result, capacity/package, guarded restage, documentation normalization,
and same-reviewer rereviews remain open. Task 10 is paused.
