...
- [ ] Task 10 — active — activate source-selected complete Mario poses; Task 9 transition is reconciled and the animation implementation lane is now unblocked. No target/Ymir/manual evidence is implied by this activation.
