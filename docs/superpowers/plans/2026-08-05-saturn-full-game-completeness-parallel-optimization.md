...
- [ ] Task 20 — active/source-incomplete — implement the bounded effect inventory/descriptor/lowering slice after preflight. The source report records five BILLBOARD, 30 ALPHA, 18 TRANSLUCENT, 34 SHADOW, zero PARTICLE, and zero DECAL records; nine effect-related records remain blocked by the two unsupported geo constructs. Source observer capture, final closure, target/Ymir replay, and FPS remain open.
