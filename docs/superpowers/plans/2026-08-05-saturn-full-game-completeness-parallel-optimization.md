...
- [ ] Task 20 — repair active/source-incomplete — bounded implementation `1c89a2bb`; independent review SPEC/QUALITY FAIL, C0/I2/M2. Exact effect inventory/oracle, VDP1 mapping, stable 64-bin painter order, and serial actor regressions are green; canonical bank identity and shared direct-descriptor validation are under repair. Nine geo-blocked records, production observer capture, final closure, target/Ymir replay, and FPS remain open.
...
- [x] Commit bounded implementation as `1c89a2bb`; repair canonical bank identity and shared direct-descriptor validation before acceptance. Final closure/target evidence remains open.
