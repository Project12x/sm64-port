...
- [ ] Task 11 — active — compile generic actor-family banks against the source-complete animation bank. Task 10 transition is reconciled; no final BOB package or target/Ymir evidence is implied.
