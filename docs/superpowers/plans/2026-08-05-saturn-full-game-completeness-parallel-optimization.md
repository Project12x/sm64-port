...
- [ ] Task 20 — active/source-incomplete — bounded implementation `1c89a2bb` complete; independent review pending. Exact effect inventory/oracle, pointer-free descriptor/lowering, VDP1 mapping, stable 64-bin painter order, overflow/stale/unknown fail-closed tests, and serial actor regressions are green. Nine geo-blocked records, production observer capture, final closure, target/Ymir replay, and FPS remain open.
