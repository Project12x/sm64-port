...
- [ ] Task 21 — Wave 0/1 bounded slice source-complete pending review; broader task source-incomplete. Project-owned generic-SMPC wrapper, cold/recovery ordering, typed command result/raw OREG31 telemetry, direct-call ownership gate, bounded waits, named faults, and serial boot/protocol regressions are green. Real seq00/AUDIO.DAT/S64P inputs, completion/identity production linkage, sourceboot feature-on, target, Ymir, manual, and audible claims remain blocked until later waves.
