...
- `SOURCE.DAT`: 1,849,904 → 2,049,200 bytes (+199,296 ≈ 194.6 KiB for 46 additional models), total ≈1.95 MiB, well under the 4 MiB cap. (An earlier version of this note said "640 KiB" here — that figure didn't match any of the correct numbers and was corrected during this sprint's final holistic review; the underlying commit message `6c8f50d` had the right delta all along.)
