...
enum {
    ...
    SM64_SATURN_PCM_PRODUCER_OFFSET = 0x04008U,
    SM64_SATURN_PCM_CONSUMER_OFFSET = 0x0400AU,
    SM64_SATURN_PCM_COMMANDS_CONSUMED_OFFSET = 0x0400CU,
    SM64_SATURN_PCM_VOICES_STARTED_OFFSET = 0x0400EU,
    SM64_SATURN_PCM_UNKNOWN_OPCODES_OFFSET = 0x04010U,
    SM64_SATURN_PCM_LAST_OPCODE_OFFSET = 0x04012U,
    SM64_SATURN_PCM_ACTIVE_SLOT_OFFSET = 0x04014U,
    SM64_SATURN_PCM_INVALID_SAMPLES_OFFSET = 0x04016U,
    SM64_SATURN_PCM_PROTOCOL_FAULTS_OFFSET = 0x04018U,
    ...
    SM64_SATURN_PCM_PROTOCOL_VERSION = 1U,
...
_Static_assert(SM64_SATURN_PCM_PROTOCOL_FAULTS_OFFSET + 2U <=
                   SM64_SATURN_PCM_RING_OFFSET,
               "status header must end before ring");
