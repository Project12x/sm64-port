...
enum {
    ...
    /* Immutable BOB semantic-SFX metadata lives in the otherwise driver-
     * reserved window. It is copied only before SNDON; MC68000 code reads
     * these pointer-free big-endian bytes directly from sound RAM. */
    SM64_SATURN_PCM_SFX_BUNDLE_OFFSET = SM64_SATURN_PCM_RESERVE_OFFSET,
    SM64_SATURN_PCM_SFX_BUNDLE_BYTES =
        SM64_SATURN_PCM_BANK_OFFSET - SM64_SATURN_PCM_RESERVE_OFFSET,
    SM64_SATURN_PCM_SFX_BUNDLE_MAGIC = 0x53465842U, /* "SFXB" */
    SM64_SATURN_PCM_SFX_BUNDLE_VERSION = 1U,
    SM64_SATURN_PCM_SFX_BUNDLE_HEADER_BYTES = 32U,
    ...
    SM64_SATURN_PCM_SFX_BUNDLE_CHAIN_MAX = 4U,
    /* Target-only semantic-music diagnostics live in the unused tail of the
     * existing 0x5000..0x7fff reserve, immediately before the PCM bank.  They
     * are intentionally outside the SFXB bytes and do not change the v2
     * mailbox/ring ABI or consume additional sound RAM. */
    SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET = 0x07F00U,
    SM64_SATURN_PCM_MUSIC_STARTS_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 0U,
    SM64_SATURN_PCM_MUSIC_FAULTS_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 2U,
    SM64_SATURN_PCM_MUSIC_VM_TICKS_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 4U,
    SM64_SATURN_PCM_MUSIC_ACTIVE_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 6U,
    SM64_SATURN_PCM_MUSIC_NOTES_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 8U,
    SM64_SATURN_PCM_MUSIC_SEQUENCE_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 10U,
    SM64_SATURN_PCM_MUSIC_SEQUENCE_BYTES_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 12U,
    SM64_SATURN_PCM_MUSIC_REJECT_MASK_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 14U,
    SM64_SATURN_PCM_MUSIC_MALFORMED_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 16U,
    SM64_SATURN_PCM_MUSIC_DROPPED_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 18U,
    SM64_SATURN_PCM_MUSIC_CONSUME_FAIL_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 20U,
    SM64_SATURN_PCM_MUSIC_SCSP_FAIL_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 22U,
    SM64_SATURN_PCM_MUSIC_LAST_NOTE_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 24U,
    SM64_SATURN_PCM_MUSIC_LAST_ARG1_OFFSET =
        SM64_SATURN_PCM_AUDIO_DIAGNOSTIC_OFFSET + 26U,
    SM64_SATURN_PCM_MUSIC_LAST_ARG0_OFFSET =
...
_Static_assert(SM64_SATURN_PCM_SFX_BUNDLE_HEADER_BYTES <=
                   SM64_SATURN_PCM_SFX_BUNDLE_BYTES,
               "SFX bundle header must fit driver reserve");
